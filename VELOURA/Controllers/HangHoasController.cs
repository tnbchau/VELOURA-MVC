...
namespace VELOURA.Controllers
{
    public class HangHoasController : Controller
    {
        private readonly VelouraContext _context;

        public HangHoasController(VelouraContext context)
        {
            _context = context;
        }
        ...
        {
            var velouraContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await velouraContext.ToListAsync());
        }
